...
[_MAIN] = KEYMAP(
      ...
      MO(_FN), KC_A, KC_S, KC_D, KC_F, KC_G,                        KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_BSLS,
    KC_LSHIFT, KC_Z, KC_X, KC_C, KC_V, KC_B,                        KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_NO, KC_NO,

         KC_LCTRL, KC_LGUI, KC_LALT, KC_ESC,                        KC_VOLU, KC_ENTER, KC_SPC, KC_BSPC,
                    KC_LSHIFT,                                      KC_VOLD, MO(_FN)
),
